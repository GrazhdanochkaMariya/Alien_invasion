...
class AlienInvasion:
    ...
    def _check_play_button(self, mouse_pos):
        """Starting a new game when Play is pushed."""
        ...
        if button_clicked and not self.stats.game_active:
            ...
            # Creating new fleet and placing a sheep in the center of the screen.
            self._create_fleet()
    ...
    def _fire_bullet(self):
        """Creates new bullet and includes it in 'bullets' group."""
        if len(self.bullets) < self.settings.bullets_allowed:
            new_bullet = Bullet(self)
            self.bullets.add(new_bullet)

    def _create_fleet(self):
        """Creates invasion fleet."""
        # Creates alien and counts number of aliens in raw.
        # The interval between aliens is equal to the width of the alien.
        alien = Alien(self)
        alien_width, alien_height = alien.rect.size
        available_space_x = self.settings.screen_width - (2 * alien_width)
        number_aliens_x = available_space_x // (2 * alien_width)

        # Defines number of rows fit on the screen.
    ...
    def _create_alien(self, alien_number, row_number):
        """Creates alien and  place it in row."""
        alien = Alien(self)
        alien_width, alien_height = alien.rect.size
    ...
    def _update_screen(self):
        ...
        # Play button displays just when the game is inactive.
    ...
    def _check_bullet_alien_collisions(self):
        # Alien hit test.
        # When a hit is detected, remove the bullet and the alien.
    ...
    def _ship_hit(self):
        ...
        if self.stats.ships_left > 0:
            ...
            # Create new fleet and place the ship in center.
            self._create_fleet()
            self.ship.center_ship()
    ...
    def _update_aliens(self):
        """Update position of each alien and check if fleet is on the edge."""
        ...
        # Check if the alien reached the bottom of the screen.
    ...
    def _check_aliens_bottom(self):
        ...
        for alien in self.aliens.sprites():
            if alien.rect.bottom >= screen_rect.bottom:
                # The same as in the ship collisions with aliens.
                self._ship_hit()
                break
